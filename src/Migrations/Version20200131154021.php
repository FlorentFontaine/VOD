 ...
 */
final class Version20200131154021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE vu vu TINYINT(1) NOT NULL, CHANGE genre genre INT NOT NULL');
    }
